//@
// Sound Manager
// for Building Virtual Worlds 2015 Round 4 "Stay Alive"
...
public class SoundManager : Singleton<SoundManager>
{
    ...
    void Update()
    {
        ...
        if (Input.GetKeyDown("r")) BGRainPlay();
    ...
    public void BGRainPlay()
    {
        MusicFadeInReplay(bgRainAS, 0.5f, 0.5f);
    }

    public void BGRainStop()
    {
        StartCoroutine(MusicFadeOut(bgRainAS, 0.5f, 0.01f, true));
    }
    ...
    public void SFXThunder()
    {
        float pitch;
        pitch = Random.Range(0.7f, 1.3f);
        AudioPlay(sfxThunderC, soundManager, 1f,pitch);
    }
